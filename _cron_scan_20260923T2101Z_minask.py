...
async def scan():
    ...
    for m, (yes_book, no_book) in zip(markets, all_books):
        ...
        if opp:
            ...
            # asks are DESC-sorted in /book payloads; best ask = min(), NOT asks[0]
...
print(f"📊 Near-misses (≤1.005): {len(result['near_misses'])} | priced={result['priced']} floor={result['floor']:.3f}")
